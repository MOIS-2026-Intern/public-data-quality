...
REQUIRED_VALUE_NULL_MIN_RATIO = 0.02
REQUIRED_VALUE_UNIQUE_IDENTIFIER_MIN_DISTINCT_RATIO = 0.8
...
DATE_DAY_OF_MONTH_MIN_COUNT = 5
DATE_DAY_OF_MONTH_MIN_RATIO = 0.8
DATE_DAY_OF_MONTH_MIN_DISTINCT_DAYS = 3
